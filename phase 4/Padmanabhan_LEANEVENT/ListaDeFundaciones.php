	...
	<header>
		<nav class="header">
			<h1 class="menu">
				...
				<a class="currentPage" href="ListaDeFundaciones.php" target="_blank"> Lista de Fundaciones </a>
		...
		<div class="listtable">
			<table class="table">
				...
				<tbody class="tablebody">
					<tr class="rowtable">
						<td class="imgblockuser"><img class="yellowbanner" src="imagenes/nologo.png"></td> 
