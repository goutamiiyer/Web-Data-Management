...
<body id="wrapper">
	<header>
		<nav class="header">
			<h1 class="menu">
				...
				<a class="currentPage" href="Individual.php" target="_blank"> Individual </a>
				<a class="navlink" href="HomeIndividual.php"> Inicio </a>
			</h1>
		</nav>		
	</header>
	...
	<main>
		...
		<div>
			<img class="user" src="imagenes/user.png" alt="user.png">
		</div>
		<div>
			<img class="user2" src="imagenes/user.png" alt="user.png">
		</div>
