	...
	<header>
		<nav class="header">
			<h1 class="menu">
				...
				<a class="currentPage" href="<?php echo base_url(); ?>ListaDeFundaciones" target="_blank"> Lista de Fundaciones </a>
		...
		<div class="listtable">
			<table class="table">
				...
				<tbody class="tablebody">
					<tr class="rowtable">
						<td class="imgblockuser"><img class="yellowbanner" src="<?php echo base_url(); ?>images/nologo.png"></td> 
