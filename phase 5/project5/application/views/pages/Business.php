...
<body id="wrapper">
	<header>
		<nav class="header">
			<h1 class="menu">
				...
				<img class="logo" src="images/logo-blanco.png" alt="logo-blanco.png">
				</span>
				<span class="name">LEANEVENTOS</span>
				<a class="currentPage" href="<?php echo base_url(); ?>Individual" target="_blank"> Fundacion </a>
				<a class="navlink" href="<?php echo base_url(); ?>HomeBusiness"> Inicio </a>
			</h1>
		</nav>		
	</header>
	...
	<main>
		<div class="imgslide2">
			<img class="bannercboleto" src="images/bannercontacto.jpg" alt="bannercontacto.jpg">
		</div>
		<div class="ctext">
			PERFIL
		</div>
		...
		<div>
			<img class="user" src="images/nologo.png" alt="nologo.png">
		</div>
		<div>
			<img class="user2" src="images/nologo.png" alt="nologo.png">
		</div>
