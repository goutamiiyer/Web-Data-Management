...
<body id="wrapper">
	<header>
		<nav class="header">
			<h1 class="menu">
				...
				<a class="currentPage" href="<?php echo base_url(); ?>Agente" target="_blank"> Agente </a>
	...
	<main>
		...
		<div class="ctab">
			<a class="comprarinicio" href="<?php echo base_url(); ?>ComprarBoletos.php"> Inicio </a>
		PERFIL
		</div>
		<div class="infohead">
		...
		<div>
			<img class="user" src="<?php echo base_url(); ?>images/nologo.png" alt="nologo.png">
		</div>
		<div>
			<img class="user2" src="<?php echo base_url(); ?>images/nologo.png" alt="nologo.png">
		</div>
